...
<% List<Medicina> personas = (List<Medicina>)request.getAttribute("personas");%>
		...
		<div id="contenedor">
			...
			<div id="cuerpo">
				<form action="/medicinaborrar" id="form-login" method="post">
					...
					<input name="nom" type="text" id="nom" size = "20" placeholder="Nombre del Medicina" value= ""
						autofocus="" required="">
					</p>
