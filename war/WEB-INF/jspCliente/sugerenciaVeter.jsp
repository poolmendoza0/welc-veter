...
<body >
    ...
    <div id = "envoltura">
        <div id="contenedor">
            ...
            <div id="cuerpo">
                <form action="/sugerenciasave" method="post">
					...
					<p><label>Comentario/Sugerencia:</label></p>
						<textarea name="sug" rows=7 cols=30 placeholder="Ingresa sugerencia para mejorar"></textarea> <br>
                    <p id="bot"><center><input type="submit" name="OK" value="Enviar"></center></p>
                </form>
            </div><!--fin cuerpo-->
 
            <div id="pie">Sugerencias para mejorar</div>
        </div><!-- fin contenedor -->
